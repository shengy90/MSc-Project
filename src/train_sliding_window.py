...
def train_baseline(ts_df, som_clusters, eval_date):
    ...
    baseline_model.evaluate_global_mape(train_test_split="train", train_df, test_period=eval_date)
    baseline_model.evaluate_global_mape(train_test_split="test", test_df, test_period=eval_date)
